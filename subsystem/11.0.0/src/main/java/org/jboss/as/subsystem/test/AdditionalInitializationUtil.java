...
import org.wildfly.legacy.test.controller.subsystem_11_0_0.TestModelControllerService11_0_0;
...
public class AdditionalInitializationUtil {
    ...
    public static void doExtraInitialization(AdditionalInitialization additionalInit, ControllerInitializer controllerInitializer, ExtensionRegistry extensionRegistry, ManagementModel managementModel, TestModelControllerService11_0_0 controller) {
        controllerInitializer.setTestModelControllerAccessor(new TestControllerAccessor11_0_0(controller));
    ...
    private static class TestControllerAccessor11_0_0 implements TestControllerAccessor {
        private final TestModelControllerService11_0_0 delegate;

        public TestControllerAccessor11_0_0(TestModelControllerService11_0_0 delegate) {
